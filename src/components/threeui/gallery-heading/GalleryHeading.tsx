...
export const GALLERY_HEADING_VARIANTS = {
  ...
  },  /* swift-halftone — the club's take on the halftone wall: the same one-ink
     one-stock idea, but the ink is Swift orange and the stock is warmed to
     the site's paper tones. Headline carries the club motto. */
  "swift-halftone": {
    title: "Learn Swift, Ship Real Apps",
    headline: ["LEARN SWIFT", "SHIP REAL APPS"],
    headlineWidths: [1420, 1860],
    axis: 90,
    phase: 0,
    direction: -1,
    field: "halftone",
    palette: [
      "#12110f", "#fff6ec", "#1c1b18", "#ffe6d5", "#2b2a26", "#ffd3bc",
      "#0a0a09", "#fffaf5", "#1f1e1a", "#ffe9d9", "#161513", "#f05138",
    ],
    /* headline ink: [muted line, emphasis line, offset plate] */
    ink: { dark: ["#f05138", "#fff6ec", "#12110f"], light: ["#d63f27", "#12110f", "#ffe6d5"] },
    type: { font: "didone", weight: "400", headlineSize: 1.25, tracking: 0.06 },
    motion: { spring: false, ease: 0.55 },
  },
...
/* the isolated-document recipe for the gallery wall: the authored canvas is
   cropped to the #stage element and laid over a black field */
const GALLERY_HEADING_EFFECT: EffectDefinition = {
